App = {
    ...
    initWeb3: function() {
        ...
        if (typeof web3 !== 'undefined') {
            ...
            App.web3Provider = new Web.providers.HttpProvider('http://localhost:8545');
    ...
    initContract: function() {
        $.getJSON('ChainList.json', function(chainListArtifact) {
            ...
            // and use it to instantiate a truffle contract abstract.
    ...
    reloadArticles: function() {
        // refresh account information because the balance may have changeds
        App.displayAccountInfo();
    ...
    sellArticle: function() {
        // retriee details of the article
        ...
        App.contracts.ChainList.deployed().then(function(instance) {
            ...
            console.log('Sell article result: ', result);
        }).catch(function(err) {
            console.log(err);
        });
    },
